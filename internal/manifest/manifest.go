...
const (
	...
	// RegionTypeFigure is an image/diagram whose text description was
	// generated by the local VLM (Ollama/Qwen2.5-VL layer).
	RegionTypeFigure RegionType = "figure"
	// RegionTypeScannedText is text that the layout model suspects is
	// rasterized/scanned and the VLM confirmed cannot be reliably
	// extracted this pass. Marked skipped, not dropped.
