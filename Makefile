...
UNIT_COVERPKG := ./internal/auth,./internal/auth/mock,./internal/account,./internal/account/mock,./internal/config,./internal/server,./internal/email,./internal/email/mock,./internal/graphedge,./internal/graphedge/memory,./internal/llm,./internal/llm/mock,./internal/kb,./internal/kb/memory,./internal/document,./internal/document/memory,./internal/chunk,./internal/chunk/memory,./internal/entity,./internal/entity/memory,./internal/entity/mock,./internal/objectstore,./internal/objectstore/mock,./internal/queue,./internal/queue/memory,./internal/rls,./internal/retrieval,./internal/retrieval/memory,./internal/search,./internal/search/mock,./internal/worker

# UNIT_TESTPKG: test packages that exercise UNIT_COVERPKG (excludes pgstore and other infra).
UNIT_TESTPKG := ./internal/auth ./internal/account ./internal/config ./internal/server ./internal/email ./internal/graphedge ./internal/llm \
